      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-gray-800">{t("student.viewMyResults")}</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-blue-700">{stats.totalQuizzes}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-green-700">{stats.averageScore}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-purple-700">{stats.averageAccuracy}%</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-sm text-gray-600">{t("quiz.totalPoints")}</p>
        ...
        {quizHistory.length > 0 && (
          <div className="mt-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl shadow-2xl p-8 text-white text-center">
            <h3 className="text-2xl font-bold mb-2">{t("student.greatJob")}</h3>
